...
sapphiremake -p sapphire -p hal_esp32 -p lib_battery -p lib_gfx -p lib_chromatron -p lib_gui -p lib_touchscreen -p lib_lvgl -p powermaster_9001 -c
sapphiremake -p sapphire -p hal_esp32 -p lib_battery -p lib_gfx -p lib_chromatron -p lib_gui -p lib_touchscreen -p lib_lvgl -p powermaster_9001 -t esp32
