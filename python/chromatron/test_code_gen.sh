...
PYTHONPATH=. python3 -m pytest -n auto tests/compiler/* -x -m local -v
# PYTHONPATH=. python3 -m pytest tests/compiler/test_code_gen.py -m local -v

# device tests:
# PYTHONPATH=. python3 -m pytest --cov=chromatron --cov-config=tests/.coveragerc --cov-report=html tests/compiler/test_device.py -v
