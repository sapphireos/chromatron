...
python3 -m nuitka --output-dir=bin/chromatron --include-package=pygments --standalone --onefile --verbose --verbose-output=nuitka.log chromatron.py
# install
...
# # build catbus tool
python3 -m nuitka --output-dir=bin/catbus --include-package=pygments --standalone --onefile --verbose --verbose-output=nuitka.log catbus.py
# # install
# ln -s $(pwd)/bin/catbus/catbus.dist/catbus.bin ~/.local/bin/catbus
cp $(pwd)/bin/catbus/catbus.bin ~/.local/bin/catbus

# build fx tool
python3 -m nuitka --output-dir=bin/fx --include-package=pygments --standalone --onefile --verbose --verbose-output=nuitka.log fx.py
# # install
# ln -s $(pwd)/bin/fx/fx.dist/fx.bin ~/.local/bin/fx
cp $(pwd)/bin/fx/fx.bin ~/.local/bin/fx

# # build sapphiremake tool
python3 -m nuitka --output-dir=bin/sapphiremake --include-package-data=sapphire.buildtools --include-package=pygments --standalone --onefile --verbose --verbose-output=nuitka.log sapphiremake.py
# # install
...
python3 -m nuitka --output-dir=bin/sapphireconsole --include-package=pygments --standalone --onefile --verbose --verbose-output=nuitka.log sapphireconsole.py
# # install
