...
// HAL USART
#define OPCODE_IO_USART_IS_RX_CHAR	0x50
#define OPCODE_IO_USART_SEND_CHAR	0x51
#define OPCODE_IO_USART_SEND_DATA	0x52
#define OPCODE_IO_USART_GET_CHAR	0x53
#define OPCODE_IO_USART_GET_DATA	0x54
#define OPCODE_IO_USART_RX_SIZE		0x55
#define OPCODE_IO_USART_FLUSH		0x56
