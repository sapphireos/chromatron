...
#define AUTOMATON_MAX_LOCAL_VARS    16
#define AUTOMATON_MAX_DB_VARS       16
#define AUTOMATON_CODE_LEN          254

#define AUTOMATON_FILE_MAGIC        0x4F545541  // 'AUTO'
#define AUTOMATON_RULE_MAGIC        0x454C5552  // 'RULE'
#define AUTOMATON_VERSION           2
...
typedef struct __attribute__((packed)){
    ...
    uint16_t condition_code_len;
    uint8_t action_data_len;
    uint16_t action_code_len;
