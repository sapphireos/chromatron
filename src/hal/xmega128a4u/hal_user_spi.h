...
static inline void user_spi_v_init( void );
static inline uint8_t user_spi_u8_send( uint8_t data ) __attribute__((always_inline));
static inline void user_spi_v_write_block( const uint8_t *data, uint16_t length ) __attribute__((always_inline));
static inline void user_spi_v_read_block( uint8_t *data, uint16_t length ) __attribute__((always_inline));
...
static inline uint8_t user_spi_u8_send( uint8_t data ){
...
static inline void user_spi_v_write_block( const uint8_t *data, uint16_t length ){
...
static inline void user_spi_v_read_block( uint8_t *data, uint16_t length ){
