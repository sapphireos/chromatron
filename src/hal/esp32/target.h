...
#ifdef BOOTLOADER
#define FW_START_OFFSET 0x000010000
#define FLASH_START     ( 0x40000000 + FW_START_OFFSET )
#define FW_INFO_ADDRESS 0x00020018
#define FW_LENGTH_ADDRESS FW_INFO_ADDRESS
#else
#define FW_START_OFFSET 0x000010000
#define FLASH_START     0x40000000
#define FW_INFO_ADDRESS 0x000d0018
#define FW_LENGTH_ADDRESS 0x00010018
#endif
