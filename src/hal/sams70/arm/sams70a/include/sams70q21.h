...
typedef struct _DeviceVectors
{
  ...
  void* pfnFPU_Handler;                          /* 61  SAMS70Q21 Floating Point Unit Registers (FPU) */
  ...
  void* pfnCCW_Handler;                          /* 64  SAMS70Q21 System Control Registers (SystemControl) */
  void* pfnCCF_Handler;                          /* 65  SAMS70Q21 System Control Registers (SystemControl) */
  void* pvReserved66;
  void* pvReserved67;
  void* pfnIXC_Handler;                          /* 68  SAMS70Q21 Floating Point Unit Registers (FPU) */
} DeviceVectors;
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
